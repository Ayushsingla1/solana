        ...
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const [simulationResult] = yield (0, async_retry_1.default)((_) => tslib_1.__awaiter(this, void 0, void 0, function* () {
                ...
                if (!data[0].success || data[0].gas_used === "0")
                    throw new Error(`${(_a = data[0]) === null || _a === void 0 ? void 0 : _a.vm_status} - ${JSON.stringify(data[0])}`);
                return data;
            }), { retries: 3, maxTimeout: 1000, minTimeout: 200 }).catch((e) => {
                var _a;
                if (this.irys.debug)
                    console.warn(`Tx simulation failed (3 attempts): ${(_a = e === null || e === void 0 ? void 0 : e.message) !== null && _a !== void 0 ? _a : e}`);
