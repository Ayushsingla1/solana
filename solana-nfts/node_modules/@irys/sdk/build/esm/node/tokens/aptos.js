...
import { Aptos, AptosConfig as AptosSDKConfig, Account, MimeType, postAptosFullNode, generateSignedTransaction, Ed25519PublicKey, Ed25519PrivateKey, TransactionAuthenticatorEd25519, AccountAuthenticatorEd25519, Ed25519Signature, SignedTransaction, generateSigningMessageForTransaction, } from "@aptos-labs/ts-sdk";
...
export default class AptosConfig extends BaseNodeToken {
    ...
    async getFee(amount, to) {
        ...
        const [simulationResult] = await AsyncRetry(async (_) => {
            ...
            return data;
        }, { retries: 3, maxTimeout: 1_000, minTimeout: 200 }).catch((e) => {
            if (this.irys.debug)
