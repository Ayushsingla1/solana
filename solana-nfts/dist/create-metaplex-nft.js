...
const getUser = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const collectionNftAddress = (0, umi_1.publicKey)("GE3ZdCPwFcRM6NM8sLapic9YzUQECz8fP2mz1iRQP2T8");
    ...
    const explorerLink = (0, helpers_1.getExplorerLink)("address", mint.publicKey, "devnet");
    console.log(`Collection NFT:  ${explorerLink}`);
    console.log(`Collection NFT address is:`, mint.publicKey);
